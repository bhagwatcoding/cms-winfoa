...
import { Calendar, Clock, Activity, CheckCircle2, Shield } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Your account overview and activity summary</p>
      </div>
