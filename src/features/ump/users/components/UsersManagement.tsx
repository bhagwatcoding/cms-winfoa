...
import { Users, Search, Filter, MoreVertical, UserPlus, CheckCircle2, XCircle, Shield, Key, RefreshCw, Trash2, Eye, LogOut, Power, User, } from 'lucide-react';
import {
    Button, Input, Badge, useToast,
    DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger,
    Select, SelectContent, SelectItem, SelectTrigger, SelectValue,
    Card, CardContent, CardDescription, CardHeader, CardTitle,
    Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle,
} from '@/ui';
import { getUsersAction, updateUserAction, deleteUserAction } from '@/actions/users';
import {
    activateUserAction,
...
import { PERMISSION_GROUPS, getPermissionLabel, type Permission } from '@/lib/permissions/constants';
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">
                        Manage all users across all subdomains
                    </p>
                </div>
