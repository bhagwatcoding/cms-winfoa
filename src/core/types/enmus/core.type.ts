...
export const getDeviceTypeLabel = (deviceType: DeviceType): DeviceTypeLabelValue => DeviceTypeLabels[deviceType];
export const isValidDeviceType = (deviceType: DeviceType): boolean => Object.values(DeviceType).includes(deviceType);
...
export const getUserRoleLabel = (userRole: UserRole): UserRoleLabelValue => UserRoleLabels[userRole];
export const isValidUserRole = (userRole: UserRole): boolean => Object.values(UserRole).includes(userRole);
...
export const getUserStatusLabel = (userStatus: UserStatus): UserStatusLabelValue => UserStatusLabels[userStatus];
export const isValidUserStatus = (userStatus: UserStatus): boolean => Object.values(UserStatus).includes(userStatus);
...
export const getSessionStatusLabel = (sessionStatus: SessionStatus): SessionStatusLabelValue => SessionStatusLabels[sessionStatus];
export const isValidSessionStatus = (sessionStatus: SessionStatus): boolean => Object.values(SessionStatus).includes(sessionStatus);
...
export const getLoginMethodLabel = (loginMethod: LoginMethod): LoginMethodLabelValue => LoginMethodLabels[loginMethod];
export const isValidLoginMethod = (loginMethod: LoginMethod): boolean => Object.values(LoginMethod).includes(loginMethod);
...
export const getRiskLevelLabel = (riskLevel: RiskLevel): RiskLevelLabelValue => RiskLevelLabels[riskLevel];
export const isValidRiskLevel = (riskLevel: RiskLevel): boolean => Object.values(RiskLevel).includes(riskLevel);
...
export const getProtocolTypeLabel = (protocolType: ProtocolType): ProtocolTypeLabelValue => ProtocolTypeLabels[protocolType];
export const isValidProtocolType = (protocolType: ProtocolType): boolean => Object.values(ProtocolType).includes(protocolType); 