...
import { Input, Button, Label, Card, CardContent, CardDescription, CardHeader, CardTitle, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, useToast } from '@/components/ui';
import { createStudent } from '@/lib/actions/edu/students';
import { getCourses } from '@/lib/actions/edu/courses';
