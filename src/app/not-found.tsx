...
export default function NotFound() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-96 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-b-[4rem] z-0" />
            <div className="absolute top-10 right-10 w-20 h-20 bg-yellow-400 rounded-full blur-3xl opacity-20" />
            <div className="absolute top-20 left-20 w-32 h-32 bg-blue-400 rounded-full blur-3xl opacity-20" />
