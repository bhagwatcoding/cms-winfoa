...
import { AmountInput, PaymentMethodSelector, ActionButton, FormCard } from '@/features/wallet';
...
export default function RechargePage() {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-6 px-4 py-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Amount Form */}
      <FormCard title="Enter Amount" description="Choose or enter the amount to add" icon={Plus}>
