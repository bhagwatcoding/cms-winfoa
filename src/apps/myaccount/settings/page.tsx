...
import { Settings, User, Mail, Phone, MapPin, Save, Bell, Shield, Globe } from 'lucide-react';
        ...
        >
          ...
          <div className="p-6 space-y-6">
            {[
              ...
              <div
                key={index}
                className="flex items-center justify-between p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
              >
                ...
                <button
                  className={`relative w-12 h-6 rounded-full transition-colors ${
                    pref.enabled ? 'bg-indigo-500' : 'bg-slate-300 dark:bg-slate-600'
                  }`}
                >
                  <div
