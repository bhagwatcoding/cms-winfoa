...
import { Monitor, Smartphone, Laptop, Globe, Clock, MapPin, LogOut, XCircle } from 'lucide-react';
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-lg border bg-amber-500/10 border-amber-500/30 p-4">
          <p className="text-sm font-medium text-amber-600 dark:text-amber-400">Idle</p>
          <p className="text-3xl font-bold text-amber-600 dark:text-amber-400">{idleSessions}</p>
        </div>
