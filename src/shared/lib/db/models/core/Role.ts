...
import { ISoftDelete } from "@/types"; // Ensure this exists or define locally

// 1. Interface Definition
// -------------------------
export interface IRole extends Document, ISoftDelete {
  name: string; // Readable name: "Super Admin"
  slug: string; // Code-friendly ID: "super-admin"
  description?: string;
  ...
  // System flags
  isSystem: boolean; // If true, this role cannot be deleted (e.g., 'super-admin')
